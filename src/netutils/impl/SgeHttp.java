...
import netutils.http.SyncRequestHandler;
...
public class SgeHttp {
    ...
    */
    ...
    private  HttpEntity nameValePair2Entity(List<NameValuePair> nameValuePairs){
    ...
    public Object post2Service(String url,List<NameValuePair> nameValuePairs,String contentType){
    	HttpEntityEnclosingRequestBase request = new HttpPost(url);
        if(nameValuePairs != null) request.setEntity(nameValePair2Entity(nameValuePairs));
  ...
  //------------------put 请求-----------------------
    ...
    protected <T> void sendRequest(DefaultHttpClient client, HttpContext httpContext, HttpUriRequest uriRequest, String contentType, RequestCallBack<T> ajaxCallBack) {
        if(contentType != null) {
