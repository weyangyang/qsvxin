 ...
 * 删除商城订单
 */
public class DeleteStoreOrderForm {
    private Context mContext;
    private String str_secretKey;
    private String str_orderId;
    private DeleteStoreOrderParserData parserDataCallBack;
     ...
     *         "用户密钥错误" }
     */
    public DeleteStoreOrderForm(Context mContext, String str_secretKey, String str_orderId,
            DeleteStoreOrderParserData parserDataCallBack) {
        ...
        new CompleteStoreOrderFormTask(mContext, str_secretKey, str_orderId, new NetDataCallBackInterf() {
            ...
            public void getNetData(int statusCode, String strJson) {
                if (HttpStatus.SC_OK == statusCode) {
                    try {
                        ParserEngine.getInstance().parserDeleteStoreOF(strJson, parserDataCallBack);
    ...
    class CompleteStoreOrderFormTask extends QsAsyncTask {
        ...
        protected void onPreExectue() {
            mCustomDialog = CustomDialog.createLoadingDialog(mContext, "正在删除商城订单", true);
        }

        @Override
        protected void doInbackgroud() {
            RequestEngine.getInstance().deleteStoreOrder(str_secretKey, str_orderId, callBackInterf);
        }
